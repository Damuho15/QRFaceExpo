...
3. If you find a definitive, high-confidence match with one of the members, set 'matchFound' to true and provide the 'id' and 'fullName' of that member. You must return the 'id' field as a valid UUID string.
