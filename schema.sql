...
CREATE TABLE public.attendance_log_1sttimer (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
INSERT INTO public.event_config (id, pre_reg_start_date, event_date, updated_at) VALUES (1, '2024-01-01', '2024-01-07', now());

-- Create the user_qrface table for application users
CREATE TABLE public.user_qrface (
    id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
